...
- Flutter version and platform targets
...
What type of data?
  ...
  Complex objects, offline -> Hive or Isar
  Relational with queries  -> sqflite
```
...
1. **Analyze requirements** from use cases and tech constraints
...
8. **Document choices** in a library-selection document
