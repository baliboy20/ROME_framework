...
import type { ScrapingOptions, ScrapedContent } from '../../types/scraper.types';
...
describe('ScraperService', () => {
  ...
  beforeEach(() => {
    ...
    mockQueue = {
      add: jest.fn().mockImplementation((fn: any) => fn()),
      pending: 0,
      size: 0
    };
    ...
    (scraperService as any).browser = mockBrowser;
    (scraperService as any).queue = mockQueue;
    (scraperService as any).turndownService = mockTurndownService;
  });
  ...
  describe('shutdown', () => {
    it('should close browser when shutting down', async () => {
      ...
      expect((scraperService as any).browser).toBeNull();
    });

    it('should handle shutdown when browser is null', async () => {
      (scraperService as any).browser = null;
  ...
  describe('cancelBatch', () => {
    ...
    it('should not cancel completed batch', async () => {
      ...
      if (progress) {
        ...
        (scraperService as any).batchProgress.set(batchId, progress);
      }
  ...
  describe('Content Processing', () => {
    describe('extractKeywords', () => {
      it('should extract Flutter-related keywords', () => {
        ...
        const keywords = (scraperService as any).extractKeywords(content);
      ...
      it('should remove duplicate keywords', () => {
        ...
        expect(keywords).toContain('flutter');
        expect(keywords).toContain('widget');
        expect(keywords.filter((k: string) => k === 'flutter')).toHaveLength(1);
      });
    });

    describe('categorizeContent', () => {
      it('should categorize as flutter', () => {
        const category = (scraperService as any).categorizeContent(
      ...
      it('should default to general', () => {
        const category = (scraperService as any).categorizeContent(
          'https://medium.com/random-article',
    ...
    describe('calculateReadingTime', () => {
      it('should calculate reading time correctly', () => {
        const readingTime1 = (scraperService as any).calculateReadingTime(200);
        const readingTime2 = (scraperService as any).calculateReadingTime(600);
        const readingTime3 = (scraperService as any).calculateReadingTime(50);
    ...
    describe('getRandomUserAgent', () => {
      it('should return a user agent string', () => {
        const userAgent = (scraperService as any).getRandomUserAgent();
      ...
      it('should return different user agents', () => {
        const userAgent1 = (scraperService as any).getRandomUserAgent();
        const userAgent2 = (scraperService as any).getRandomUserAgent();
    ...
    describe('clearCompletedBatches', () => {
      it('should clear completed batches', async () => {
        ...
        if (progress1) {
          ...
          (scraperService as any).batchProgress.set(batchId1, progress1);
        }
