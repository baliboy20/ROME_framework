...
export class ArticlesController {
   ...
   */
  getArticleContent = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params;
      if (!id) {
        res.status(400).json({
   ...
   */
  getArticleStats = async (req: Request, res: Response): Promise<void> => {
    try {
   ...
   * List article files
   */
  listArticleFiles = async (req: Request, res: Response): Promise<void> => {
    try {
