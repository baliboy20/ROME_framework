...
**Priority**: MEDIUM - Design Decision Guide
**Dependencies**:
...
**Related Documentation**:
  ...
  - 📘 [Core Artifacts](core_artifacts_expert.md) - Enum examples
  - 📘 [Error Handling Patterns](../01_CORE/error_handling_patterns_expert.md) - Sealed class usage
  - 📘 [Frontend DDD Architecture](../01_CORE/frontend_ddd_architecture_expert.md) - Domain patterns

**Quick Links**:
  - Section 1: [Quick Decision Tree](#1-quick-decision-tree)
  - Section 2: [When to Use Enums](#2-enums-when-and-why)
  - Section 3: [When to Use Sealed Classes](#3-sealed-classes-when-and-why)
  - Section 4: [Side-by-Side Comparison](#4-side-by-side-comparison)
