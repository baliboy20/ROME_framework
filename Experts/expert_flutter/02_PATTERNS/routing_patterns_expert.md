...
**Related Documentation**:
  ...
  - 📘 [Frontend DDD Architecture](../01_CORE/frontend_ddd_architecture_expert.md) - Presentation layer
  - 📘 [BLoC Event Naming](../01_CORE/bloc_event_naming_convention_guide.md) - State on route transitions
  - 📘 [Error Handling Patterns](../01_CORE/error_handling_patterns_expert.md) - Error routes

**Quick Links**:
  - Section 2: [Router Architecture](#2-router-architecture)
  - Section 3: [Route Types](#3-route-types)
  - Section 5: [Authentication Guards](#5-authentication-guards)
  - Section 9: [BLoC Integration](#9-bloc-integration-in-routes)
