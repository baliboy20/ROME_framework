...
Agents live in agents, referenced by phase plugins:

- **P0:** `ROME/agents/bootstrap/`
- **P1:** `ROME/agents/talib/` (P1 mode)
- **P2:** `ROME/agents/talib/` (P2 mode)
- **P3:** `ROME/agents/pma/`, `ROME/agents/clara/`
- **P4:** `ROME/agents/lucien/`
- **P5:** P5 robots per project capability configuration (default: `ROME/agents/ashok/`, `reena/`, `charlie/`)
- **QA:** `ROME/agents/sarah/`
- **Core:** `ROME/agents/roma/`
