...
| **TDR-13** | webapp-customer static+islands; **webapp-admin Flutter macOS desktop (DEV-5 — Web SPA retired)**; webapp-editor Flutter Web SPA; mobile-guide **Web PWA only** (DEV-3) | §2 |
