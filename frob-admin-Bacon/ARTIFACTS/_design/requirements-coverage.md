...
| REQ-BOOK15 | webapp-admin (A23) | bookings, participants, departures | PATCH /admin/bookings/:id (owner-assisted edit, DR-B12b; atomic capacity move, TDR-08) |
| REQ-BOOK16 | webapp-admin (A23) | bookings, departures, payments | POST /admin/bookings/:id/transition (constrained transitions, DR-B12c) |
