...
**Category**: Frontend & UI / Error Handling
**Phase**: P5 (Generation)
**Robot**: Charlie
...
- api-design.md (error responses from backend)
- use-cases.md (error scenarios)
- Generated Flutter code (domain, data, presentation layers)
...
- `01_CORE/error_handling_patterns_expert.md` (27KB) - Complete error handling guide
- `02_PATTERNS/error_boundary_placement_strategy.md` (17KB) - Where to place boundaries
- `01_CORE/antipatterns_and_approved_libraries_expert.md` - Don't use dartz Either

**Related Guides:**
- `02_PATTERNS/timeout_strategy_guide.md` - Timeout handling
- `03_INTEGRATIONS/parse_flutter_integration_patterns.md` - Parse error handling

## AORDL Traceability

- Error responses (API) → Exception types
- Error scenarios (use-cases) → Failure types
- Recovery requirements → Recovery strategies
- User messaging → Error message mapping

---

**Version**: 1.0
**Based on**: Experts/expert_flutter/01_CORE/error_handling_patterns_expert.md
