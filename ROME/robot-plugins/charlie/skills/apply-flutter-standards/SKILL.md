...
**Category**: Frontend & UI / Code Quality
**Phase**: P5 (Generation)
**Robot**: Charlie

## Purpose

Apply Flutter coding standards, best practices, and architectural patterns to generated code

## Inputs

- Generated Flutter source code
- tech-stack.md (Flutter version, architecture pattern)
- design-system.md (Flutter-specific styling approach)
...
- Performance requirements → ListView optimization
- Accessibility requirements → Semantic widgets
