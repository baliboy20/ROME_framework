...
- **Styling & Theming**
  ...
  - Implement CSS/styling solutions
...
As a Rodeo, Charlie follows the standard 7-step task execution process:
1. Review assigned frontend tasks
...
- **Static Assets**: `./SOURCE/frontend/assets/`
