...
**Phase**: P3 (Design) or P5 (Generation)
**Robot**: Charlie
...
- api-design.md (backend integration contracts)
- tech-stack.md (Flutter architecture pattern selected)
...
1. **Design Domain Layer**
   - Define entities from data-dictionary.yaml
   - Create repository interfaces
   - Design use cases from use-cases.md
...
- `01_CORE/frontend_ddd_architecture_expert.md` (27KB) - Complete architecture guide
- `01_CORE/bloc_event_naming_convention_guide.md` (19KB) - Event naming patterns
- `01_CORE/antipatterns_and_approved_libraries_expert.md` (39KB) - What to avoid
- `02_PATTERNS/core_artifacts_expert.md` (18KB) - Shared entities and enums
- `05_REFERENCE/best_practices_consolidated_guide.md` (25KB) - Quick reference

**Related Guides:**
- `01_CORE/error_handling_patterns_expert.md` - Result type implementation
- `02_PATTERNS/sealed_classes_vs_enums_guide.md` - When to use sealed classes

## AORDL Traceability

- Use cases → Domain use cases
- Entities → Domain entities
- API contracts → Data layer models
- Business rules → Use case implementations
- User workflows → BLoC event flows
...
**Version**: 1.0
**Based on**: Experts/expert_flutter/01_CORE/frontend_ddd_architecture_expert.md
