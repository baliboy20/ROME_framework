...
**Changelog**: Added standards review phase before contract definition
...
## Enhanced TDD-ROME Workflow

### Phase 0: Standards Review (BLOCKING)
**Roma validates all development plans against technical standards**

```
┌─────────────────────────────────────────────────────┐
│              STANDARDS REVIEW PHASE                  │
│                                                      │
│  Roma (delegated PMA authority)                     │
│  ├── Review robot development plans                 │
│  ├── Validate against standard guides               │
│  ├── Approve architecture patterns                  │
│  ├── Escalate missing standards to PMA              │
│  └── Block progression until standards compliance   │
│                                                      │
│  Output: Approved development plans                  │
└─────────────────────────────────────────────────────┘
```
...
### Roma's Enhanced Checklist
```markdown
## Standards Review Phase (NEW)
- [ ] Development plan follows applicable standard guide
- [ ] Architecture patterns align with project standards  
- [ ] Technology choices justified and approved
- [ ] Testing strategy meets coverage requirements
- [ ] Plan approved for proceeding to contract tests
- [ ] Missing standards escalated to PMA if applicable
...
2. **Standards Review**: Roma validates development plans against standards
3. **Contract Definition**: 2-3 days defining all interfaces with tests
4. **Test Distribution**: Each robot gets their contract test suite
5. **Implementation**: Make tests pass (no new features without tests)
6. **Integration**: All contract tests passing = guaranteed integration
