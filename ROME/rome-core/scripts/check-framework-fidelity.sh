...
if [ ! -f "$ONTOLOGY" ]; then
  ...
  ENFORCED_AXIOMS="AX-01 AX-02 AX-03 AX-04 AX-05 AX-06 AX-07 AX-08 AX-17 AX-18 AX-19 AX-21 AX-22 AX-23 AX-24 AX-26 AX-27 AX-29 AX-30 AX-31 AX-32 AX-34 AX-35 AX-36 AX-37 AX-38 AX-39"
  if [ ! -d "$TESTS_DIR" ]; then
