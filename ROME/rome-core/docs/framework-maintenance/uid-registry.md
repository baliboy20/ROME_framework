...
| Field | Value |
|-------|-------|
| **Document UID** | ROME-GOV-002 || **Version** | 4.8 |
...
| ROME-PROP-047 | Input Characterization & Reliability Gating | `/ROME_framework_maintenance/proposals/ROME-PROP-047-input-characterization-and-reliability.md` | Draft |
