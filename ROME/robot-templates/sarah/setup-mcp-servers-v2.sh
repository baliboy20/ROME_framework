...
claude mcp add --transport stdio Seez -- \
...
claude mcp add --transport stdio rome-terminal -- \
  dart run /Users/will/flutterProjects/Apps/Local/mcps/rome/version7/ro-term/bin/mcp_bridge_server.dart \
