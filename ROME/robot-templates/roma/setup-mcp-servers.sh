...
claude mcp add activity-log dart \
  run \
...
claude mcp add Seez dart \
  run \
  /Users/will/flutterProjects/Apps/Local/mcps/rome/version7/seez_mcp/bin/mcp_server.dart \
  --description "Seez v2 - MCP server for visualizing Mermaid diagrams and Markdown content in tabbed views" \
...
claude mcp add rome-terminal dart \
  run \
  /Users/will/flutterProjects/Apps/Local/mcps/rome/version7/ro-term/bin/mcp_bridge_server.dart \
